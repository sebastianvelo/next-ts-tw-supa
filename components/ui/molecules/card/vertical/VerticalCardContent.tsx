...
interface VerticalCardContentProps extends Pick<CardDTO, "content"> { }

const VerticalCardContent: React.FC<VerticalCardContentProps> = ({ content }) => {
    return (content && (
        <>
            <div className="px-6">
                <div className="h-px bg-gradient-to-r from-transparent via-secondary-200 dark:via-secondary-700 to-transparent" />
            </div>
            <CardBody className="px-6 pb-6 pt-4 flex-grow">
