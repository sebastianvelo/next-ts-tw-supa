...
import { getColSpan } from "@/presentation/view/constants/layout";
...
const FormFieldContainer = <T extends Record<string, any>>({ dependency, colSpan = 6, ...props }: FormFieldContainerProps<T>) => {
    ...
    return (
        <div className={`${getColSpan(colSpan)} space-y-2`} key={props.name as string}>
