...
interface FormDefaultActionsProps<T extends Record<string, any>> {
    isSubmitting: boolean;
    reset: UseFormReset<T>;
}

const FormDefaultActions = <T extends Record<string, any>>({ isSubmitting, reset, }: FormDefaultActionsProps<T>) => (
    <CardFooter>
